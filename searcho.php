    ...
    <tbody>
    	<?php 
     	if (isset($_GET['search'])) {
     		...
     		$query = "SELECT * FROM officers WHERE CONCAT(fullname,resi_address,gender,birth,age,status,height,contact,email,profile_image,create_datetime) LIKE '%$filtervalues%'";
